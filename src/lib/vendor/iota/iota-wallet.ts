...
class IOTAWallet {
   ...
   */
  async createAccountManager(name: string, password: string, options?: AccountManagerOptions): Promise<string> {
  ...
  getAccountManager(name: string, password: string, options?: AccountManagerOptions): AccountManager {
